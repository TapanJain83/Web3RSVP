...
contract Web3RSVP {
    ...
    function createNewRSVP(bytes32 eventId) external payable {
        ...
        require(msg.value == myEvent.deposit, "INSUFFICIENT DEPOSIT");
    ...
    function confirmAttendee(bytes32 eventId, address attendee) public {
        ...
        // require that msg.send er is the owner of the event - only the host should be able to check people in
